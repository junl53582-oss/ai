# Phase 2.1-B r2 — LambdaRank Target-Scope & Final Evidence Closure Report
...
| **Phase 2.1-B r2 Code** | [`e26cb7aa2d2bc884fbbbc5b1fe17a6ec3ca1a3c1`](https://github.com/junl53582-oss/ai/commit/e26cb7aa2d2bc884fbbbc5b1fe17a6ec3ca1a3c1) | r2 修复：仅 common_train 样本参与分位数计算，添加极端样本隔离单测与真 Scipy 版本 |
...
- **V1 预期 Daily RankIC Hash**: `5ec8d5630bd017892ebffe4e5069c023dfdfa7e93f5b03202470e92a6d0f52d5`
- **r2 实际 Daily RankIC Hash**: `42640bcd8506e6f9655661c0dc7258854fdf8c3813ebd0e3d3946d510e4cacba`
- **Daily RankIC 逐日最大绝对误差**: `9.89e-17` (Passed: **`True`**)
...
- **V1 预期 Daily RankIC Hash**: `548333d9765b322ebc1ef04763049e0ba5a5bb5a18cb16820c60add4eb12cff9`
- **r2 实际 Daily RankIC Hash**: `83cb779a849997fbe90a022b7bcfd619baa11b6673c54e2afe95078b3d891016`
- **Daily RankIC 逐日最大绝对误差**: `9.89e-17` (Passed: **`True`**)
- **门禁状态**: **`PASS`**
...
- **单日 Eligible 样本数量分布**: Min=`134`, Median=`168.0`, Max=`176`, Mean=`167.1`
