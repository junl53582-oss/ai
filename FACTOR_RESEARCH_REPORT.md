...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 1 | `KLEN` | `WEAK` | `WEAK` | 反向 (-1) | 3D | -0.0109 | -1.64 | 0.1125 | 16.1% | 0.71 | 53.4% | 26.9% |
| 2 | `KMID` | `REJECT` | `REJECT` | 反向 (-1) | 1D | -0.0048 | -1.96 | 0.0629 | 51.5% | 1.56 | 75.8% | 48.6% |
...
- **训练集选出因子数**: `1` 个
- **OOS 验证表现**: {'KMID': {'train_direction': -1, 'train_horizon': '1D', 'oos_raw_rank_ic': -0.0019, 'oos_aligned_rank_ic': 0.0019, 'oos_icir': 0.0252}}
### 📍 Fold 2
