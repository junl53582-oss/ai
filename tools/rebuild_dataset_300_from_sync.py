...
def main() -> bool:
    ...
    market_manifest = {
        ...
        "date_range": [str(m300["date"].min())[:10], str(m300["date"].max())[:10]],
    ...
    factor_manifest = {
        ...
        "date_min": str(factor_df["date"].min())[:10],
        "date_max": str(factor_df["date"].max())[:10],
        "date_range": [str(factor_df["date"].min())[:10], str(factor_df["date"].max())[:10]],
